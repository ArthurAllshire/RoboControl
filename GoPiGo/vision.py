...
class TrackSquare():
    ...
    def find_square(self, image):
        ...
        if len(contours) == 0:
            return erd_dlt_image, OrderedDict([('x',0), ('y',0), ('w',0), ('h',0), ('angle',0), ('u_width', 0), ('u_height', 0)])
...
def get_data(rect, image):
    ...
    return OrderedDict([('x',x), ('y',y), ('w',w), ('h',h), ('angle',angle), ('u_width', rect[1][0]), ('u_height', rect[1][1])])
